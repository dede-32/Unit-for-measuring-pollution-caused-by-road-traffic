...
void setup() {
  ...
  int16_t state = radio.begin(434.0, 125.0, 12, 7, 0x12, 10, 8, 1.6, false); // zkus SF12, možná se to někde chytne
  ...
  Serial.println(uplinkData[0]);
  Serial.print("Send temp: ");
  Serial.println(uplinkData[1]);
